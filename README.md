...
- **Quick Bill** — record a sale in seconds by selecting product, color, quantity & price
- **Best Seller Analytics** — visual pie chart showing top-selling products and colors
...
- **18 Handcraft Products** pre-loaded out of the box
- **Color-wise tracking** — track stock and sales by product color
- **Splash screen** with a warm welcome for the farmer community
- **About page** with full app guide and version info
...
| Screen | Description |
|--------|-------------|
| 🧾 **Quick Bill** | Select a product → pick color → enter qty & price → save sale |
| 📊 **Best Seller** | Pie chart of top-selling products and colors |
| 📦 **Stock** | Current inventory per product/color, add stock, low-stock warnings |
| 💰 **Income** | Total earnings for the week or month + full sale history |
...
### Clone & Run
```bash
git clone https://github.com/faisalimam1/HastaKala.git
cd HastaKala
```
...
| Version | Notes |
|---------|-------|
| **v1.0** | Initial release — Quick Bill, Best Seller, Stock, Income, Splash, About, 18 products |
